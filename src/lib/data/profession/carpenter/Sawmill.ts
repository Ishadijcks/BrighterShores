...
const rawSawmillActions: SawmillAction[] = [
	...
	{ level: 30, log: ItemId.RuggedHickoryLog, plank: ItemId.RuggedHickoryPole, exp: 63 },
	{ level: 35, log: ItemId.RuggedJuniperLog, plank: ItemId.RuggedJuniperStave, exp: 0 },
	{ level: 43, log: ItemId.RuggedPoplarLog, plank: ItemId.RuggedPoplarPole, exp: 0 },
